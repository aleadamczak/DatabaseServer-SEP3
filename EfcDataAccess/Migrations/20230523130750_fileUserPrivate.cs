...
{
    /// <inheritdoc />
    public partial class fileUserPrivate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HaveAccessId = table.Column<int>(type: "INTEGER", nullable: false),
                    SharedWithMeId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrivateFileUser", x => new { x.HaveAccessId, x.SharedWithMeId });
                    table.ForeignKey(
